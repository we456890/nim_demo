...
public class UserProfileActivity extends UI {
    ...
    View.OnClickListener onPhoneListener=new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            String phone=mobileText.getText().toString();
            if(TextUtils.isEmpty(phone)){
                Toast.makeText(UserProfileActivity.this,"没有电话号码",Toast.LENGTH_SHORT).show();
            }else{
    ...
    protected void onResume() {
        super.onResume();
        phoneLayout.setOnClickListener(onPhoneListener);
        call.setOnClickListener(onPhoneListener);
        updateUserInfo();
        updateToggleView();
    }
    ...
    private void findViews() {
        ...
        video = findView(R.id.begin_video);
        call = findView(R.id.begin_call);
