...
import com.netease.nim.demo.main.fragment.WorkBenchFragment;
import com.netease.nim.demo.main.reminder.ReminderId;

public enum MainTab {
    WORK_BENCH(0, ReminderId.WORK, WorkBenchFragment.class, R.string.work_bench, R.layout.work_bench_tab),
