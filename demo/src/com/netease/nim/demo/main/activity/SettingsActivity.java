...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private static final int TAG_UPDATEPWD = 22;
    ListView listView;
    ...
    private void initItems() {
        ...
        items.add(new SettingTemplate(TAG_UPDATEPWD, getString(R.string.updatepwd)));
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            case TAG_HEAD:
                ...
                break;
            case TAG_UPDATEPWD:
                startActivity(new Intent(SettingsActivity.this, UpdatePwdActivity.class));
//                Toast.makeText(SettingsActivity.this, "修改密码", Toast.LENGTH_SHORT).show();
                break;
