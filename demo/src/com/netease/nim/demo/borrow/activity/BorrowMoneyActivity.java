...
import com.netease.nim.demo.borrow.fragment.FragmentBorrowMoneyAudit;
import com.netease.nim.demo.borrow.fragment.FragmentBorrowMoneyCheck;
...
public class BorrowMoneyActivity extends UI implements View.OnClickListener{
    private static final String TAG = "wk_BorrowMoney";
    ...
    private void init() {
        ...
        textView.setText(R.string.borrow);
    }
    View.OnClickListener addinsert=new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(BorrowMoneyActivity.this,BorrowMoneyAddActivity.class);
    ...
    private void initFragment() {
        FragmentBorrowMoneyCheck check = new FragmentBorrowMoneyCheck();
        FragmentBorrowMoneyAudit audit = new FragmentBorrowMoneyAudit();
