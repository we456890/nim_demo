...
import com.netease.nim.demo.borrow.activity.BorrowMoneyCheckActivity;
...
public class FragmentBorrowMoneyCheck extends TFragment {
    private static String TAG = "wk_FBorrowMoneyCheck";
...
//                            Toast.makeText(getActivity(), selecttime, Toast.LENGTH_SHORT).show();
    ...
    private void getPageReporting(int page, final int status, String time) {
        ...
        String url = PublicUtils.URL +
                ...
                PublicUtils.URL_FILE_BORROWLISTACTION_TAG;
                ...
                public void run() {
                    ...
                    adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                            ...
                            intent.setClass(getActivity(), BorrowMoneyCheckActivity.class);
