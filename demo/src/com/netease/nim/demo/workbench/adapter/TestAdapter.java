package com.netease.nim.demo.workbench.adapter;
...
public class TestAdapter extends BaseAdapter {
    ...
    public TestAdapter(Context context, List<Reversion> r) {
...
//        if (null == view) {
            view = LayoutInflater.from(context).inflate(R.layout.reimburse_main_item, null);
