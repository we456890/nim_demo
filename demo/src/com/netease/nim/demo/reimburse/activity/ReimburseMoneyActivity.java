...
import com.netease.nim.demo.reimburse.fragment.FragmentReimburseApproval;
import com.netease.nim.demo.reimburse.fragment.FragmentReimburseCheck;
...
public class ReimburseMoneyActivity extends UI implements View.OnClickListener{

    private static final String TAG = "wk_ReimburseMoney";
    ...
    private void init() {
        ...
        textView.setText(R.string.reimburs);
    }
    View.OnClickListener addinsert=new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ReimburseMoneyActivity.this,ReimburseMoneyAddActivity.class);
    ...
    private void initFragment() {
        FragmentReimburseCheck check = new FragmentReimburseCheck();
        FragmentReimburseApproval approval = new FragmentReimburseApproval();
        mFragmentList.add(check);
        mFragmentList.add(approval);
    }
