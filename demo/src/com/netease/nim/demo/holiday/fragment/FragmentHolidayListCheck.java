...
import com.netease.nim.demo.holiday.activity.HolidayCheckActivity;
...
import static com.netease.nim.demo.common.util.PublicUtils.URL_FILE_HOLIDAYLISTATION_TAG;
...
public class FragmentHolidayListCheck extends TFragment {
    private static String TAG = "wk_FHolidayListCheck";
...
//                            Toast.makeText(getActivity(), selecttime, Toast.LENGTH_SHORT).show();
    ...
    private void getPageReporting(int page, final int status, String time) {
        ...
        String url = PublicUtils.URL +
                ...
                URL_FILE_HOLIDAYLISTATION_TAG;
        Map<String, String> m = new HashMap<>();
        if (u != null) {
            m.put("holiday.prayErId", u.getId());
            m.put("page", page + "");
            if (time != null) {
                ...
                public void run() {
                    ...
                    adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                            ...
                            intent.setClass(getActivity(), HolidayCheckActivity.class);
