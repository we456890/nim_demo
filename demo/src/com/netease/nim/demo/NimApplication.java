...
public class NimApplication extends Application {
    ...
    private void Sysmessage(boolean register) {
        NIMClient.getService(MsgServiceObserve.class).observeCustomNotification(new Observer<CustomNotification>() {
            ...
            public void onEvent(CustomNotification message) {
                ...
                int id = json.getIntValue("mesid");
                String mesmodel = json.getString("mesmodel");
                String messageId = json.getString("messageId");
                String mestitle = json.getString("mestitle");
                String mestext = json.getString("mestext");
                ...
                if(mesmodel!=null) {
                    switch (mesmodel) {
                        case "reporting":
                            mainIntent = new Intent(getApplicationContext(), ReportingBossCheckActivity.class);
                            mainIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            bundle = new Bundle();
                            bundle.putString("messageId", messageId);
                            mainIntent.putExtras(bundle);
                            mainPendingIntent = PendingIntent.getActivity(getApplicationContext(), 0, mainIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            break;
                        case "reversion":
                            mainIntent = new Intent(getApplicationContext(), ReportingStaffCheckActivity.class);
                            mainIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            bundle = new Bundle();
                            bundle.putString("messageId", messageId);
                            mainIntent.putExtras(bundle);
                ...
                if(mestext!=null){
                    ...
                    Log.i(TAG, "onEvent: " + id + mesmodel + messageId);
