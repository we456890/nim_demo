...
public class Preferences {
    ...
    public static void saveUserDTO(UserDTO userDTO) {
        saveObject(KEY_USERDTO, userDTO);
    }

    public static String getUserDTO() {
        return getString(KEY_USERDTO);
    }
    ...
    protected static void ClaerPreferences(){
        SharedPreferences sp = DemoCache.getContext().getSharedPreferences("Demo", Context.MODE_PRIVATE);
