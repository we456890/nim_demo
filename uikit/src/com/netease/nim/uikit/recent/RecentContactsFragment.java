...
public class RecentContactsFragment extends TFragment {
    ...
    private SimpleClickListener<RecentContactAdapter> touchListener = new SimpleClickListener<RecentContactAdapter>() {
        @Override
        public void onItemClick(final RecentContactAdapter adapter, View view, final int position) {
            RelativeLayout main = (RelativeLayout) view.findViewById(R.id.recent_main);
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            deleterecent(adapter.getItem(position), position);
//                            Toast.makeText(getActivity(), "aaaaa", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
//            final Button tootop = (Button)view.findViewById(R.id.totop);
//            tootop.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View view) {
//                    getActivity().runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            String title = (isTagSet(adapter.getItem(position), RECENT_TAG_STICKY)  ?  getString(R.string.main_msg_list_sticky_on_top) : getString(R.string.main_msg_list_clear_sticky_on_top));
//                            tootop.setText(title);
//                            if (isTagSet(adapter.getItem(position), RECENT_TAG_STICKY)) {
//                                removeTag(adapter.getItem(position), RECENT_TAG_STICKY);
//                            } else {
//                                addTag(adapter.getItem(position), RECENT_TAG_STICKY);
//                            }
//                            NIMClient.getService(MsgService.class).updateRecent(adapter.getItem(position));
//
...
//            });
    ...
    private void deleterecent(final RecentContact recent, final int position) {
        // 删除会话，删除后，消息历史被一起删除
