...
//    static final String URL="http://192.168.1.110:8080/manual_pure/";
    static final String URL = "http://118.31.184.230:8000/gt_beta/";
    static final String URLTAG = "mobileCommon/mobileCommon!getAndroidVersion";
    ...
    static final String UPDATE_URL = URL + URLTAG;
}
